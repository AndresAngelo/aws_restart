"""
Your module description - Lab126: Creating File Handlers and Modules for Retrieving Information about Insulin
"""

import jsonFileHandler

data = jsonFileHandler.readJsonFile('Lab126/insulin.json')
